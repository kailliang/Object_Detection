...
#MODEL_NAME = 'mask_rcnn_inception_resnet_v2_atrous_coco_2018_01_28'    #[771,26]283.10
MODEL_NAME = 'faster_rcnn_inception_resnet_v2_atrous_coco_2018_01_28'   #[620,37]312.73 best
#MODEL_NAME = 'mask_rcnn_resnet50_atrous_coco_2018_01_28'    #[343,29]
#MODEL_NAME = 'faster_rcnn_resnet101_coco_2018_01_28'         #[106,32]84.43
#MODEL_NAME = 'ssd_mobilenet_v1_coco_2018_01_28'             #[30,21]14.80
#MODEL_NAME = 'ssd_resnet50_v1_fpn_shared_box_predictor_640x640_coco14_sync_2018_07_03' #[76,35] 38.99 
#MODEL_NAME = 'ssd_inception_v2_coco_2017_11_17'            #[42,24]
#MODEL_NAME = 'faster_rcnn_inception_v2_coco_2018_01_28'    #[58,28]
    ...
    with detection_graph.as_default():
      with tf.Session(graph=detection_graph) as sess:
        ...
        for image_path in TEST_IMAGE_PATHS:
          ...
          cv2.imwrite(output_image_path+image_folder+'\\'+image_path.split('\\')[-1],image)
